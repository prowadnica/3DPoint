...
\DeclareFloatingEnvironment[
    fileext=code,
    listname={Lista kodów źródłowych},
    name=Kod źródłowy,
    placement=h,
]{code}
...
\begin{axis}[
title={Zależność średnicy walca warstwy od wysokości $z$},
...
\legend{Wartość poprawna,Wartość w przekroju prostopadłym,Wartość w przekroju równoległym}
\end{axis}
\end{tikzpicture}
